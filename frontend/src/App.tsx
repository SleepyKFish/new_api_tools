...
import { Login, Layout, TabType, Generator, History, TopUps, Dashboard, Redemptions, Analytics, UserManagement, RealtimeRanking, IPAnalysis, ModelStatusMonitor, MultiSourceMonitorAdmin, AutoGroup, Tokens } from './components'
import { useAuth } from './contexts/AuthContext'
import { WarmupScreen } from './components/WarmupScreen'

// Valid tabs
const validTabs: TabType[] = ['dashboard', 'topups', 'risk', 'ip-analysis', 'analytics', 'model-status', 'multi-source', 'users', 'tokens', 'auto-group', 'generator', 'redemptions', 'history']
...
function App() {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'multi-source':
        return <MultiSourceMonitorAdmin />
      case 'users':
